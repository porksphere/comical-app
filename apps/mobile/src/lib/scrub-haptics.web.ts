...
// elsewhere is no use for this: it has no amplitude or frequency, and a scrub asks for dozens of
// events a second, which on the browsers that support it at all is a continuous buzz.
//
...
export function useScrubHaptics(): ScrubHaptics {
  ...
  return { crossing: noop, settle: noop, stop: noop };
}

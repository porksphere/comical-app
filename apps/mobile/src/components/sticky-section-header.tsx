 ...
 *
 * `p` is 0 at rest, down to −`bandHeight` fully pushed out by the following heading — and is
 * SNAPPED to one of those two past a scroll speed where the intermediate states can't render as
 * motion anyway.
 */
function pinAt(

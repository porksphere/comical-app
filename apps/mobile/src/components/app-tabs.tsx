...
export default function AppTabs() {
  ...
  // See the wrapper below — rests transparent unless the series page is open.
  ...
  return (
    ...
    // backdrop the way a native presentation does — so the page drives it from here instead (see
    // lib/series-backdrop.ts). With no series page open the dim is fully transparent.
